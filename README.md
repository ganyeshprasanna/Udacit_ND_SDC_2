...
The model was able to correctly guess 4 of the 5 traffic signs, which gives an accuracy of 80%. The images are not clear and the accuracy is similar to our test accuracy. The accuarcy might get higher if we have more than 5 samples.
